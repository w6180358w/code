...
<body>
   ...
   <div id="crudWin" style="display: none;">
   		<table class="insert-tab" width="100%">
        	...
        	<tbody>
        		<tr>
                    <th><i class="require-red">*</i>数据源名称(name)：</th>
                    <td id="txt-name"></td>
                </tr>
                <tr>
                    <th>数据库类型：</th>
                ...
                <tr>
                    <th><i class="require-red">*</i>数据库名称(Database Name)：</th>
                    <td id="txt-dbName"></td>
                </tr>
                <tr>
...
grid = new FDGrid({
	...
	,url:listUrl
	,columns:[
		{text:'数据源名称',name:'name',style:{width:'80px'}}
		,{text:'数据库名',name:'dbName',style:{width:'80px'}}
		,{text:'IP',name:'ip',style:{width:'150px'}}
...
formPanel = new FDFormPanel({
	...
	,controls:[
	    ...
	    ,new FDTextArea({domId:'txt-ignore',name:'ignore',msgId:'formMsg',width:200})
	]
});
